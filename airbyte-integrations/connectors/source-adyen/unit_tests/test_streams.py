...
import pytest
from source_adyen.source import AdyenStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AdyenStream, "path", "v0/example_endpoint")
    mocker.patch.object(AdyenStream, "primary_key", "test_primary_key")
    mocker.patch.object(AdyenStream, "__abstractmethods__", set())
