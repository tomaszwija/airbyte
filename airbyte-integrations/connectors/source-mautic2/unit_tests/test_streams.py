...
import pytest
from source_mautic2.source import Mautic2Stream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(Mautic2Stream, "path", "v0/example_endpoint")
    mocker.patch.object(Mautic2Stream, "primary_key", "test_primary_key")
    mocker.patch.object(Mautic2Stream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = Mautic2Stream()
