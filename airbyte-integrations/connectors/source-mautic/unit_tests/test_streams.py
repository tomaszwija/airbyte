...
import pytest
from source_mautic.source import MauticStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MauticStream, "path", "v0/example_endpoint")
    mocker.patch.object(MauticStream, "primary_key", "test_primary_key")
    mocker.patch.object(MauticStream, "__abstractmethods__", set())
